...
# ============================================================
#  Wan2/generate_multiple.sh
#  Launches multiple Wan2.2 workers across GPUs.
...
if [[ "$MODEL_SIZE" != "14b" && "$MODEL_SIZE" != "5b" ]]; then
    echo "ERROR: --model-size must be 14b or 5b"
    exit 1
fi
...
LOG_DIR="$OUTPUT_DIR/logs_wan_multi"
mkdir -p "$OUTPUT_DIR" "$LOG_DIR"

echo "============================================"
echo "  Wan2.2 multi-GPU generation"
echo "  Mode         : $MODE"
